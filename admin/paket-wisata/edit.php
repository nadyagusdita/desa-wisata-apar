...
$sql   = mysqli_query($db, "SELECT * FROM paket_wisata WHERE id_paket_wisata = $id");
                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="form-group mb-3">
                                        ...
                                        <textarea class="ckeditor" id="ckeditor" name="tentang_wisata" required><?= $data['tentang_wisata']; ?></textarea>
                                    </div>
                                </div>
                                <div class=" col-12">
                                    <div class="form-group mb-3">
                                        <label for="contact_person" class="mb-1">Contact Person</label>
                                        <input class="form-control" type="text" id="contact_person" name="contact_person" required value="<?= $data['contact_person']; ?>">
                                    </div>
                                </div>
